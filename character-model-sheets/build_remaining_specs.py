...
DATA = {
    ...
    '085': dict(g='男性', age='中老年', face='清瘦长脸、眉目沉静', hair='灰黑头发藏于灰色高帽', beard='细黑上髭与尖山羊胡', body='修长文士体型', costume='紫灰宽袖长袍、黑色胸带、绿色宽裤与灰色高帽', palette='紫灰、黑、绿、白', weapon=None, mount=None, pet=None, asym='双手结印属于动作，不作为永久左右结构', unknown='帽后发型、长袍背面与腰带闭合不可见'),
